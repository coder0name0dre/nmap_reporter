...
**Important:** This tool can optionally run `nmap' from the script, but that functionality is in tentionally disabled by default. **Only run networl scans against hosts/networks you ownor have explicit permission to scan.**
